...
vim.keymap.set("n", "<leader>t5", function() vim.cmd [[ToggleTerm direction=vertical size=60]] end, {desc = "Opens a horizontal  terminal split"})
vim.keymap.set("n", "<leader>tt", function() vim.cmd [[ToggleTerm direction=float]] end, {desc = "Opens a floating terminal"})
...
vim.keymap.set("n", "<leader>ha", function() vim.cmd [[:lua require("harpoon.mark").add_file()]] end, {desc = "add current file to the harpoon menu"})

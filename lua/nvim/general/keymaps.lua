...
end, { desc = "open telescope(finder) builtin" })
...
vim.keymap.set("n", "<leader>Tt", function()
	vim.cmd([[:PickTelescopeTheme]])
end, { desc = "Pick telescope (finder) themes" })
vim.keymap.set("n", "<leader>Tl", function()
	vim.cmd([[:PickLualineTheme]])
end, { desc = "Pick lualine (statusbar) themes" })
...
end, { desc = "Enable lualine (statusbar)" })
vim.keymap.set("n", "<leader>ld", function()
	vim.cmd([[set laststatus=0]])
end, { desc = "Disable lualine (statusbar)" })
...
vim.keymap.set("n", "<leader>cf", function()
	vim.cmd([[echo 'Formatted successfully' | Format]])
...
vim.keymap.set("n", "<leader>cd", function()
	vim.cmd([[Trouble]])
end, { desc = "Diagnostics using Trouble" })

-- PERF: chtshts
vim.keymap.set("n", "<leader>vc", function()
	vim.cmd([[e ~/.config/nvim/lua/nvim/chtshts/chtsht.md]])
end, { desc = "Open vim cheat sheat" })
vim.keymap.set("n", "<leader>vb", function()
	vim.cmd([[e ~/.config/nvim/lua/nvim/chtshts/files.md]])
end, { desc = "Files in vim chtsht" })
vim.keymap.set("n", "<leader>vf", function()
	vim.cmd([[e ~/.config/nvim/lua/nvim/chtshts/general.md]])
end, { desc = "How to do stuff in this config" })
...
end, { desc = "Open parent directory in tree format" })
...
vim.keymap.set("n", "<Tab>", function()
	vim.cmd([[bn]])
end, { desc = "Toggle buffer focus" })

-- PERF: Vim be good
vim.keymap.set("n", "<leader>pv", function()
	vim.cmd([[VimBeGood]])
end, { desc = "Practice vim" })
...
vim.keymap.set("n", "<leader>ze", function()
	vim.cmd([[set laststatus=0 | set nonu | set nornu | BufferLineGroupToggle ungrouped]])
end, { desc = "Enable zenmode" })
vim.keymap.set("n", "<leader>zd", function()
	vim.cmd([[set laststatus=2 | set nu | set rnu | BufferLineGroupToggle ungrouped]])
end, { desc = "Disable zenmode" })
...
vim.keymap.set("n", "<leader>cp", function()
	vim.cmd([[Glow %]])
end, { desc = "Preview markdown files" })
...
vim.api.nvim_set_keymap(
	...
	{ noremap = true, silent = true, desc = "Toggle transparent backbackground" }
)

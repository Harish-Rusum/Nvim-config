...
vim.api.nvim_create_autocmd("ColorScheme", {
    ...
    callback = function()
        ...
        local telescope_highlights = {
            ...
            TelescopeBorder = { bg = darken(colors.mantle, darken_percentage), fg = darken(colors.mantle, darken_percentage) },
            TelescopePromptNormal = { bg = darken(colors.surface0, darken_percentage) },
            TelescopePromptBorder = { bg = darken(colors.surface0, darken_percentage), fg = darken(colors.surface0, darken_percentage) },
            ...
            TelescopeResultsBorder = { bg = darken(colors.mantle, darken_percentage), fg = darken(colors.mantle, darken_percentage) },
            ...
            TelescopePreviewBorder = { bg = darken(colors.base, darken_percentage), fg = darken(colors.base, darken_percentage) },
